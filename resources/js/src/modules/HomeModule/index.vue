<template>
  <div>
    <div class="flex flex-col gap-10 px-16 py-10">
      <div class="w-full flex flex-row justify-center items-start gap-5">
        <div class="basis-1/4">
          <TrendingSidebar />
        </div>
...
export default {
  components: {
    TrendingSidebar: () => import('../../components/TrendingSidebar'),
    LatestSidebar: () => import('../../components/LatestSidebar')
  }
}
</script>
